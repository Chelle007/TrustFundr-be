...
public class ViewFundraisingActivitiesDoneeController {
    ...
    public List<ViewFundraisingActivitiesDoneeResponse> viewFundraisingActivities() {
        // Load all active fundraising activities (newest first) and map each to response
        return fundraisingActivityRepository.findAllPublicOrderByCreatedAtDesc().stream()
